...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(800, 800, "2D Square Scaling", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (scaleUp)
        {
            ...
            if (scaleFactor >= 2.0f)  // Set a limit for scaling up
                scaleUp = false;
        }
        else
        {
            scaleFactor -= 0.001f;  // Scale down by 0.001 units per frame
